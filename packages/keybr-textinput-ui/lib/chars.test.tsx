...
test("render chars", (t) => {
  ...
  t.deepEqual(
    ...
    [
      <span key={0} className="chars normal hit">
        a
      </span>,
      <span key={1} className="chars normal miss">
        b
      </span>,
      <span key={2} className="chars normal hit">
        c
      </span>,
      <span key={3} className="chars special hit">
        {"\uE000"}
      </span>,
      <span key={4} className="chars normal cursor">
        x
      </span>,
      <span key={5} className="chars normal">
        yz
      </span>,
    ],
  );
  ...
  t.deepEqual(
    ...
    [
      <span key={0} className="chars normal">
        U+0000
      </span>,
      <span key={1} className="chars normal">
        U+0001
      </span>,
      <span key={2} className="chars normal">
        U+0002
      </span>,
    ],
  );
