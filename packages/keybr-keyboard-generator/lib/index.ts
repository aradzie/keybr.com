...
for (const [output, keymap] of [
  ...
  ["en_us_canary_matrix.ts", LAYOUT_EN_CANARY_MATRIX],
  ["en_us_colemak.ts", LAYOUT_EN_COLEMAK],
  ["en_us_colemak_dh.ts", LAYOUT_EN_COLEMAK_DH],
  ["en_us_colemak_dh_matrix.ts", LAYOUT_EN_COLEMAK_DH_MATRIX],
  ["en_us_dvorak-win.ts", convertCldr("cldr-keyboards-43.0/keyboards/windows/en-t-k0-windows-dvorak.xml")],
  ["en_us_workman.ts", LAYOUT_EN_WORKMAN],
