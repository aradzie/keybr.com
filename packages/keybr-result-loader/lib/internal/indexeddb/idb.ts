...
export class DBIndex {
  ...
  count(query?: IDBValidKey | IDBKeyRange): Promise<number> {
    return promisifyRequest(this.#idx.count(query));
  }

  get(query: IDBValidKey | IDBKeyRange): Promise<any> {
    return promisifyRequest(this.#idx.get(query));
  }
  ...
  getAll(
    ...
    return promisifyRequest(this.#idx.getAll(query, count));
  }
  ...
  getAllKeys(
    ...
    return promisifyRequest(this.#idx.getAllKeys(query, count));
  }
  ...
  openCursor(
    ...
    return promisifyRequest(this.#idx.openCursor(query, direction));
  }
  ...
  openKeyCursor(
    ...
    return promisifyRequest(this.#idx.openKeyCursor(query, direction));
  }
  ...
  readAll<T>(
    ...
    return readAll(parse, this.#idx.openCursor(query, direction));
  }
