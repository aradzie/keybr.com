...
describe("handle primitive values", () => {
...
describe("handle DOMException objects", () => {
  test(
    "DOMException",
    macro(new DOMException(), "Error (code=0) (type=[object DOMException])"),
  );
  test(
...
describe("handle any objects", () => {
  test("Custom object", macro({}, "Unknown (type=[object Object])"));
  test(
    "Custom object with name",
    macro({ name: "Foo" }, "Foo (type=[object Object])"),
  );
  test(
    "Custom object with message",
    macro({ message: "abc" }, "Unknown: abc (type=[object Object])"),
  );
  test(
    "Custom object with code",
    macro({ code: "ENOENT" }, "Unknown (code=ENOENT) (type=[object Object])"),
  );
  test(
