      ...
      <Slide size="small" target={`#${names.currentKey}`} position="s">
        <FormattedMessage
          ...
          defaultMessage={
            ...
            "<dl>" +
            "<dt>Average typing speed</dt>" +
            "<dd>Your average typing speed for this individual letter.</dd>" +
