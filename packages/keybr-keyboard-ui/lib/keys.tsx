...
const key = (props: KeyProps): ReactNode => {
  ...
  return (
    <Key {...props}>
      <rect className={styles.button} x={0} y={0} width={40} height={40} />
...
const keyF = (props: KeyProps): ReactNode => {
  ...
  return (
    <Key {...props}>
      <rect className={styles.button} x={0} y={0} width={40} height={40} />
      <circle className={styles.bump} cx={20} cy={35} r={3} />
      {b > 0 && !ab && <Secondary x={10} y={15} codePoint={b} />}
      {a > 0 && !ab && <Secondary x={10} y={30} codePoint={a} />}
      {d > 0 && !cd && <Secondary x={28} y={15} codePoint={d} />}
      {c > 0 && !cd && <Secondary x={28} y={30} codePoint={c} />}
...
const keyBackslash = (props: KeyProps): ReactNode => {
  ...
  return (
    <Key {...props}>
      <rect className={styles.button} x={0} y={0} width={60} height={40} />
      {b > 0 && !ab && <Secondary x={10} y={15} codePoint={b} />}
      {a > 0 && !ab && <Secondary x={10} y={30} codePoint={a} />}
      {d > 0 && !cd && <Secondary x={28} y={15} codePoint={d} />}
      {c > 0 && !cd && <Secondary x={28} y={30} codePoint={c} />}
...
const keyLeftShift = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={92} height={40} />
    <Label x={15} y={25} text="Shift" />
  </SpecialKey>
);
const keyLeftShiftStandard102 = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={50} height={40} />
    <Label x={15} y={25} text="Shift" />
  </SpecialKey>
);
const keyRightShift = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={115} height={40} />
    <Label x={15} y={25} text="Shift" />
  </SpecialKey>
);
const keyCtrl = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={63} height={40} />
...
const keyCapsLock = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={70} height={40} />
    <Label x={15} y={25} text="Caps Lock" />
  </SpecialKey>
);
const keyBackspace = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={83} height={40} />
    <Label x={15} y={25} text="Backspace" />
  </SpecialKey>
);
const keyEnter = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <rect className={styles.button} x={0} y={0} width={95} height={40} />
    <Label x={15} y={25} text="Enter" />
  </SpecialKey>
);
const keyEnterStandard102 = (props: KeyProps): ReactNode => (
  <SpecialKey {...props}>
    <path className={styles.button} d="m 0,0 0,40 7,0 0,42 53,0 0,-82 z" />
    <Label x={15} y={25} text="Enter" />
  </SpecialKey>
);
const keySpace = (props: KeyProps): ReactNode => (
  <Key {...props}>
    <rect className={styles.button} x={0} y={0} width={369} height={40} />
  </Key>
);
...
const keyNpAdd = (props: KeyProps): ReactNode => (
  <Key {...props}>
    <rect className={styles.button} x={0} y={0} width={40} height={82} />
    <Primary x={15} y={25} text="+" />
  </Key>
);
...
const keyNp0 = (props: KeyProps): ReactNode => (
  <Key {...props}>
    <rect className={styles.button} x={0} y={0} width={82} height={40} />
