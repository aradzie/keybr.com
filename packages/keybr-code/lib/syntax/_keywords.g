...
kw_complex64 -> { :class(keyword) "complex64" };
kw_complex128 -> { :class(keyword) "complex128" };
...
kw_float32 -> { :class(keyword) "float32" };
kw_float64 -> { :class(keyword) "float64" };
...
kw_func -> { :class(keyword) "func" };
kw_function -> { :class(keyword) "function" };
kw_get -> { :class(keyword) "get" };
...
kw_int8 -> { :class(keyword) "int8" };
kw_int16 -> { :class(keyword) "int16" };
kw_int32 -> { :class(keyword) "int32" };
kw_int64 -> { :class(keyword) "int64" };
kw_interface -> { :class(keyword) "interface" };
kw_interface -> { :class(keyword) "interface" };
kw_internal -> { :class(keyword) "internal" };
...
kw_rune -> { :class(keyword) "rune" };
kw_satisfies -> { :class(keyword) "satisfies" };
kw_sealed -> { :class(keyword) "sealed" };
kw_self -> { :class(keyword) "self" };
kw_set -> { :class(keyword) "set" };
...
kw_uint -> { :class(keyword) "uint" };
kw_uint8 -> { :class(keyword) "uint8" };
kw_uint16 -> { :class(keyword) "uint16" };
kw_uint32 -> { :class(keyword) "uint32" };
kw_uint64 -> { :class(keyword) "uint64" };
